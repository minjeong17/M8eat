...
-- 아침 식단 (diet_no = 1)
(1, 102, '계란 프라이', 50, 75, 6.3, 5.5, 0.5, 0.1, 186),
(1, 102, '밥', 200, 312, 6, 1, 69, 0.1, 0),
(1, 102, '김치', 50, 15, 1.1, 0.2, 3, 1, 0),

-- 점심 식단 (diet_no = 2)
(2, 102, '닭가슴살', 150, 165, 31, 3.6, 0, 0, 85),
(2, 102, '고구마', 100, 86, 1.6, 0.1, 20, 4.2, 0),
(2, 102, '샐러드', 80, 30, 1, 2, 4, 1, 0),

-- 저녁 식단 (diet_no = 3)
(3, 102, '연어구이', 120, 206, 22, 13, 0, 0, 55),
(3, 102, '현미밥', 180, 270, 5, 2, 55, 0.2, 0),
(3, 102, '브로콜리', 50, 17, 1.9, 0.2, 3.3, 0.5, 0);
